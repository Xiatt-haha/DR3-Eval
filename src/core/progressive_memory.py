...
class MemoryCompressor:
    ...
    def _get_light_compression_prompt(self, content: str) -> str:
        ...
        return f"""Please compress the following content to 1/3 of its original length, retaining all key information, data, and citations:

{content}

Compressed content (retaining key information):"""
    
    def _get_heavy_compression_prompt(self, content: str) -> str:
        """Get prompt for heavy compression"""
        return f"""Please compress the following content into 3-5 core points, retaining only the most important information:
